...
export class JwtHelper {
    ...
    public getJwtObject(accessToken: string) {
        ...
        const header: JwtHeader = JSON.parse(this.base64Decode(this.base64UrlToBase64(t[0])));
        const payload: JwtPayload = JSON.parse(this.base64Decode(this.base64UrlToBase64(t[1])));

...
describe("Enum Test", () => {
  it("UserStatusType", () => {
    ...
    expect(UserStatus.REGISTER.name).toBe("등록");
    expect(UserStatus.ACTIVE.name).toBe("정상");
    expect(UserStatus.SUSPEND.name).toBe("휴면");
    expect(UserStatus.DELETE.name).toBe("탈퇴");
